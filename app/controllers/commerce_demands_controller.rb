...
before_filter  :authenticate_admin!,:except => [:index, :show]  
  ...
  def index
    @commerce_demands = CommerceDemand.search(params[:search], params[:search1])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @commerce_demand.save
        format.html { redirect_to @commerce_demand, :notice => 'Commerce demand was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @commerce_demand.update_attributes(params[:commerce_demand])
        format.html { redirect_to @commerce_demand, :notice => 'Commerce demand was successfully updated.' }
